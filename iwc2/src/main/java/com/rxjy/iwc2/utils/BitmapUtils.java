...
public class BitmapUtils {
     ...
     * @return
     */
    private static Bitmap getImage(String srcPath, float ww, float hh) {
        ...
        float height = hh;// 这里设置高度为800f
        float width = ww;// 这里设置宽度为480f
     ...
     * @return
     */
    public static String compressImageUpload(String path , float hh , float ww) {
